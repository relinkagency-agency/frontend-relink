  ...
  return (
    <>
      <section className="relative h-[520px] md:h-[650px] lg:h-[750px] w-full overflow-hidden bg-[#0B0D13]">
        ...
        <div className="absolute text-white lg:top-98 lg:bottom-60 md:bottom-40 bottom-10 top-40 md:top-0 md:left-20 left-5  md:max-w-4xl max-w-[800px]">
        ...
        <div className="absolute text-white bottom-5 md:bottom-30 left-5 md:left-0 lg:left-auto lg:right-20 font-relink-headline lg:text-4xl max-w-4xl uppercase">
