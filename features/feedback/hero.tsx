  ...
  return (
    <>
      <div className="relative h-[520px] md:h-[650px] lg:h-screen w-full overflow-hidden">
        ...
        <div className="absolute text-white bottom-32 md:bottom-30 lg:bottom-20 left-5 md:left-20 lg:left-30 font-relink-headline text-5xl lg:text-7xl md:max-w-4xl max-w-2xl">
